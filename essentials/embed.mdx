...
## The Embed
You can get the embed code from the [Dashbaord > Store settings > Looop Embed](https://manage.uselooop.com/looop-script) and paste it in the head of your Webflow site.

The embed code looks like this:

```html
<script defer src="https://embed.uselooop.com" store="REPLACE_WITH_YOUR_STORES_ID" domain="YOUR_SHOPIFY_MYSHOPIFY_DOMAIN" key="SHOPIFY_STOREFRONT_API_KEY"></script>
```
<Note>
