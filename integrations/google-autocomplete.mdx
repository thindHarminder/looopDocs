...
7. Click the project drop-down and select the project that you want to use the API key with.
8. To restrict an API key, click restriction for websites adn then add your domain name to the list of allowed domains. Like `*.yourdomain.com/*`
